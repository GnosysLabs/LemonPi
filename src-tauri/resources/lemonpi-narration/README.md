...
First-party Pi extension bundled with LemonPi. It supplies visible narration, a read-only Main Pi supervisor contract, independent delegated-run scheduling, child checklists, durable mission recovery, and direct steering/stop controls without patching `pi-subagents`.
